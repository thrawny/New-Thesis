...
During the lifetime of CIMS, the influx of data can be seen in ~\ref{fig:jeTrend}. This figure clearly shows the trend in the data inflow of CIMS. The trend is hitherto increasing, with factors involved in describing the origin of this trend. Shorter lead times, organization more experienced with CIMS, Agile, LEAN.
